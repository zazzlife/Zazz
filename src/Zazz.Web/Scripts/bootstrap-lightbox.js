    ...
    Lightbox.prototype = {
        ...
        centerImage: function () {
            ...
            if (that.options.resizeToFit) {
                ...
                var imgMaxWidth = that.$element.width() - 465;
                var imgMaxHeight = that.$element.height() - 22;
                ...
                $img.data('max-width', imgMaxWidth);
                $img.data('max-height', imgMaxHeight);
                ...
                if ($img[0].naturalWidth > imgMaxWidth) {
