...
namespace Zazz.UnitTests.Infrastructure.Services
{
    ...
    public class PhotoServiceShould
    {
        ...
        [Test]
        public void AddCategoriesIfAvailable_OnSavePhoto()
        {
            //Arrange
            var photo = new Photo
            {
            ...
            _uow.Setup(x => x.PhotoRepository.InsertGraph(It.Is<Photo>(p =>
        ...
        [Test]
        public void NotAddInvalidCategories_OnSavePhoto()
        {
            //Arrange
            var photo = new Photo
            {
        ...
        [Test]
        public void SavePhotoToDBAndCreateAFeedRecordWhenLastPhotoAlbumIsNotTheSame_OnSavePhoto()
        {
            //Arrange
            var photos = new List<FeedPhoto>
                         {
