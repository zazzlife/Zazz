...
{
    [TestFixture]
    public class PostCommentsControllerShould : BaseOAuthTests
    {
        ...
        public override void Init()
        {
            ...
            _commentId = 99;
            _postId = 444;
            ControllerAddress = "/api/v1/comments/posts/" + _postId;
        ...
        {
            //Arrange
            ControllerAddress = "/api/v1/comments/posts/" + 0;
        ...
        public async Task GetCommentsUsingFeedHelper_OnGet()
        {
            ...
            _feedHelper.Setup(x => x.GetComments(_postId, CommentType.Post, User.Id, 0, 10))
