...
namespace Zazz.IntegrationTests.Repositories
{
    ...
    public class ValidationTokenRepositoryShould
    {
        ...
        {
            //Arrange
            var token = new UserValidationToken { ExpirationTime = DateTime.Now.AddDays(1), Id = 1, Token = Guid.NewGuid() };
        ...
        {
            //Arrange
            var token = new UserValidationToken { ExpirationTime = DateTime.Now.AddDays(1), Token = Guid.NewGuid() };
